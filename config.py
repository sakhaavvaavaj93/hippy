...
ALIVE_IMG = getenv("ALIVE_IMG", "http://telegra.ph/file/1832b630289cb9b731944.jpg")
START_PIC = getenv("START_PIC", "http://telegra.ph/file/1832b630289cb9b731944.jpg")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "60"))
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/sakhaavvaavaj93/krishna")
